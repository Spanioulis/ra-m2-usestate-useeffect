...
function App() {
  ...
  useEffect(() => {
    const allSizes =
      Number(triangle.size) === Number(circle.size) &&
      Number(triangle.size) === Number(square.size);
    const allColors =
      triangle.color === circle.color && triangle.color === square.color;
  ...
  return (
    <div className="App">
      ...
      <Figure
        ...
        // Convierte las figuras en SVG, a nivel de components/atoms
        style={{
